 ...
 * @LastEditTime: 2020-07-09 17:47:52
      ...
      mapUrl: [
        {
          ...
          id: 1,
          value: 'gaodeSitelliteMap', // 影像底图（不含路网，不含注记）
  ...
  methods: {
    ...
    initBaseMap () {
      ...
      this.maps = [
        ...
        // 高德影像图
        new Cesium.ImageryLayer(new Cesium.UrlTemplateImageryProvider({
          url: this.mapUrl.find(item => item.value === 'gaodeSitelliteMap').url,
          subdomains: ['1', '2', '3', '4']
        }), {
          show: false
        }),
        ...
        // 天地图影像图
        new Cesium.ImageryLayer(new Cesium.WebMapTileServiceImageryProvider({
          url: this.mapUrl.find(item => item.value === 'tianSitelliteMap').url,
          layer: 'tianSitelliteMap',
          style: 'default',
          format: 'tiles',
          tileMatrixSetID: 'c',
          subdomains: ['0', '1', '2', '3', '4', '5', '6', '7'],
        ...
        // google 影像图
        new Cesium.ImageryLayer(new Cesium.WebMapTileServiceImageryProvider({
          url: this.mapUrl.find(item => item.value === 'googleSitelliteMap').url,
      ...
      this.maps.forEach((item, index) => {
        this.$parent.viewer.imageryLayers.add(item, index)
      })
    },
    /**
